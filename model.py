...
# Getting dataset for the .csv file ..
data = pd.read_csv("./data/data.csv")

# loading the pickled model ..
song_cluster_pipeline = pickle.load(open("./data/song_cluster_pipeline","rb"))

# Connecting with Spotify Client ..
...
def recommend_songs( song_list, spotify_data, n_songs=50):
